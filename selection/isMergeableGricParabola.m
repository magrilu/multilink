function [ok, msScore, msOutput] = isMergeableGricParabola(X, L, i, j, lambda1 , lambda2, sigma)
...
mi = fit_parabola(Xi);
mj = fit_parabola(Xj);
mij = fit_parabola(Xij);
% compute the residuals
ri = res_parabola(Xi, mi);
rj = res_parabola(Xj, mj);
rij = res_parabola(Xij, mij);
