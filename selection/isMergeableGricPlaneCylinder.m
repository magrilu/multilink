function [ok, msLC, msOutput] = isMergeableGricPlaneCylinder(X, L, i, j, lambda1 , lambda2, sigma)
...
if(o_verbose)
       f = [msPlane.fidelity.before, msPlane.fidelity.after, msCylin.fidelity.before, msCylin.fidelity.after];
       c = [msPlane.complexity.before, msPlane.complexity.after, msCylin.complexity.before, msCylin.complexity.after]./lambda2;
       disp('--------------------------------------')
       disp([scores;f;c]);
       disp('--------------------------------------')
end
